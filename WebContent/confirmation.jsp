...
<header>
	<div class="container">
		...
		<h1>
			PUBHUB <small>Confirmation </small>
		</h1>
			...
			<div class="col-xs-12">
				<c:choose>
					...
					<c:otherwise>
						...
						<c:set var="order" value="${ProcessedOrder}" />
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-2 text-center">
										Total <br> <b>
											$<c:out
												value="${order.grandTotal}" /></b>
									</div>
									<div class="col-xs-2 text-center">
										Type<br><b><c:out value="${order.status}" /></b>
									</div>
									<div class="col-xs-2 text-center">
										
									</div>
									<div class="col-xs-4 text-right">
										Order N#:<c:out value="${order.id}" />
									</div>
								</div>
							</div>
							...
							<div class="panel-body">
								...
								<c:forEach var="cartItem" items="${itemsBought}">
									<div class="row ">
										<div class="col-xs-2">
										...
										<div class="col-xs-2"><b>Unit Price</b><br>
											<fmt:formatNumber value="${cartItem.books.price}"
												type="CURRENCY" />
										</div>
										<div class="col-xs-2"><b>Qty Ordered</b><br>
											<c:out value="${cartItem.quantity}" />


										</div>
										<div class="col-xs-2 visible-lg text-right"><b>SubTotal</b><br>
											<span>$</span>
							...
							<div class="panel-footer">
								<p>You can review your order details and download your
									digital items by visiting your account page</p>
							</div>
						</div>
